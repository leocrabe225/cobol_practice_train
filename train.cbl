      ...
      *46 TIMES car il y a 46 ligne dans le fichier
           05 WS-LIGNE-TRAIN OCCURS 46 TIMES.
              ...
              10 WS-HEURE-DEPART.
                  15 WS-HEURE-DEPART-HH PIC X(2).
                  15 WS-HEURE-DEPART-MM PIC X(2).
      ...
      *un output pour l'affichage 
       ...
       0100-MOVE-TO-OUTPUT-BEGIN.
           EVALUATE WS-TYPE-TRAIN(WS-TRAIN-TO-WRITE)
               WHEN TGV
           ...
           MOVE WS-HEURE-DEPART-HH(WS-TRAIN-TO-WRITE)
               TO OUT-TRAIN-TIME-HH.
           MOVE WS-HEURE-DEPART-MM(WS-TRAIN-TO-WRITE)
               TO OUT-TRAIN-TIME-MM.
           MOVE WS-DUREE-TRAJET(WS-TRAIN-TO-WRITE)
               TO OUT-TRAIN-NMBR-HEURES.
      *    MOVE WS-TBL-TRAIN-STOPS(WS-TRAIN-TO-WRITE) TO OUT-TRAIN-STOPS.
      *    MOVE WS-TBL-TRAIN-END-TIME-HH(WS-TRAIN-TO-WRITE)
      *        TO OUT-TRAIN-END-TIME-HH
      *    MOVE WS-TBL-TRAIN-END-TIME-MM(WS-TRAIN-TO-WRITE)
